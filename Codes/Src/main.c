...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
   ...
   if(x>=10){
    ...
    mcu_dp_value_update(DPID_WATER_LEFT,waterpercentage);           //         SOME EXAMPLE CODES
                                                                    //         FOR UPDATIN THE TUYA
    mcu_dp_value_update(DPID_TDS_OUT,tds_out);                      //         DATA
    x=0 ;                                                           //
    if(temp>50){                                                    //
    	temp=0 ;                                                    //
    }                                                               //
...
switch(wifi_state){
 ...
 case WIFI_CONN_CLOUD:
    printf("WIFI CONNECTED TO THE CLOUD\n");
  //  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5,SET);
...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
  wifi_protocol_init();  // necessary code for tuya wifi communication
  ...
  while (1)
  {
	 ...
	 // necessary code for tuya wifi communication
	  wifi_uart_service() ;
	  ...
	  // AHT10 measuring the temperature ;
	  aht10_temp() ;
...
;
        //    sprintf("Temperature: %.2f",AHT10_Temperature);
