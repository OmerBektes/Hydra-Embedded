...
******************************************************************************/
#define PRODUCT_KEY "apgwqdzq4otmle4a"    //The unique product identification generated after product is created on development platform
...
******************************************************************************/
//Switch(Issue and report)
#define DPID_SWITCH 1
//Mode(Issue and report)
#define DPID_WORK_MODE 2
//Filter Left(Only report)
#define DPID_FILTER_DAYS 3
//Clean Left(Only report)
#define DPID_PUMP_TIME 4
//Filter Reset(Issue and report)
#define DPID_FILTER_RESET 5
//Clean Reset(Issue and report)
#define DPID_PUMP_RESET 6
//Filter Life(Issue and report)
#define DPID_FILTER_LIFE 7
//Clean Life(Issue and report)
#define DPID_TIME_CLEAN 8
//Water Level(Only report)
#define DPID_WATER_LEVEL 9
//Water Percentage(Only report)
#define DPID_WATER_LEFT 10
//Water Control(Issue and report)
#define DPID_WATER_CONTROL 11
//Bright Value(Issue and report)
#define DPID_BRIGHT_VALUE 12
//Tds Out(Only report)
#define DPID_TDS_OUT 13
//UV(Issue and report)
#define DPID_UV 14
//UV Runtime(Issue and report)
#define DPID_UV_RUNTIME 15
//Warm(Issue and report)
#define DPID_WARM 16
//Temp Set(Issue and report)
#define DPID_TEMP_SET 17
//Temp Current(Only report)
#define DPID_TEMP_CURRENT 18
//Push Floating Hair(Issue and report)
#define DPID_PUSH 19
//Power Mode(Only report)
#define DPID_POWER_MODE 20
//Battery Percentage(Only report)
#define DPID_BATTERY_PERCENTAGE 21
//Water Intake(Only report)
#define DPID_WATER_INTAKE 22
//Fault(Only report)
#define DPID_FAULT 23
//Water Time(Only report)
#define DPID_WATER_TIME 24
//Water Reset(Issue and report)
#define DPID_WATER_RESET 25
